...
-A PREROUTING -i eth0 -p tcp --dport 2000 -j DNAT --to-destination 192.168.50.5:2000
-A PREROUTING -p udp --dport 8047 -j DNAT --to-destination 192.168.50.1
-A PREROUTING -p udp --dport 8042 -j DNAT --to-destination 192.168.50.1

# Masquerade only outbound traffic from 192.168.50.0/24 going out on eth0
