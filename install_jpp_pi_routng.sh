...
# Note. This version routes  the traffic from JB WLAN  to the external interface. Configure  a static route on your router for 192.168.50.0/24 to the assigned eth0 IP address you set in your DHCP. 

# REQUIRED: Set configuration variables for JB_WLAN, JB_WLAN_PASSWORD, JB_MAC, JPP_JUICEBOX_ID, JPP_MQTT_HOST, JPP_MQTT_PASS, JPP_MQTT_USER.
...
# Set up iptables rules for UDP port redirection
echo "Setting up iptables rules for UDP port redirection..."
