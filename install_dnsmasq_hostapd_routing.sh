...
# Change any ip address ranges for the wlan0 AP inteface facing the juicebox
...
sudo iptables -t nat -A PREROUTING -p udp --dport 8047 -j DNAT --to-destination 192.168.50.1
sudo iptables -t nat -A PREROUTING -p udp --dport 8042 -j DNAT --to-destination 192.168.50.1
